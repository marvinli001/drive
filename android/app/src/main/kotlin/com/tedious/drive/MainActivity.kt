...
class MainActivity: FlutterActivity() {
    private val downloadChannel = "drive/downloader"
    ...
    private fun download(title: String, fileName: String, uri: String, headers: Map<String, String>?, destination: String?): String {
        ...
        if (destination == null) {
            ...
            request.setDestinationUri(Uri.fromFile(File(context.filesDir.path + "com.drive/app_flutter/offlined-files", "xxx")))
